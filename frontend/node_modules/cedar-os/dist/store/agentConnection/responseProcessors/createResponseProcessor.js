...
var createResponseProcessor_exports = {};
__export(createResponseProcessor_exports, {
  LegacyActionResponseSchema: () => LegacyActionResponseSchema,
  SetStateResponseSchema: () => SetStateResponseSchema,
  createLegacyActionResponseProcessor: () => createLegacyActionResponseProcessor,
  createResponseProcessor: () => createResponseProcessor,
  createSetStateResponseProcessor: () => createSetStateResponseProcessor
});
module.exports = __toCommonJS(createResponseProcessor_exports);
...
function createLegacyActionResponseProcessor(config) {
  const { namespace, setterKey, execute, validate } = config;
  const defaultValidate = (obj) => {
...
//# sourceMappingURL=createResponseProcessor.js.map