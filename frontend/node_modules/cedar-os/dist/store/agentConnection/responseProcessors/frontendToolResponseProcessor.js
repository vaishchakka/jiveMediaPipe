...
var frontendToolResponseProcessor_exports = {};
__export(frontendToolResponseProcessor_exports, {
  FrontendToolResponseSchema: () => FrontendToolResponseSchema,
  createFrontendToolResponseProcessor: () => createFrontendToolResponseProcessor,
  frontendToolResponseProcessor: () => frontendToolResponseProcessor
});
module.exports = __toCommonJS(frontendToolResponseProcessor_exports);
...
function createFrontendToolResponseProcessor(config) {
  return {
    type: "frontendTool",
    namespace: config.namespace || "default",
    execute: async (obj, store) => {
      if (config.beforeExecute) {
        await config.beforeExecute(obj, store);
      }
      try {
      ...
      if (config.afterExecute) {
        await config.afterExecute(obj, store);
      }
      const toolMessage = {
        ...obj,
        type: "frontendTool",
    ...
    validate: (obj) => {
      ...
      if (typeof obj.toolName !== "string")
        return false;
      if (config.toolName && obj.toolName !== config.toolName) {
        return false;
      }
      return true;
    }
...
//# sourceMappingURL=frontendToolResponseProcessor.js.map