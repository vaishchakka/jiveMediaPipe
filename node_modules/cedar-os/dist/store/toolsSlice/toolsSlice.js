...
var toolsSlice_exports = {};
__export(toolsSlice_exports, {
  createToolsSlice: () => createToolsSlice
});
module.exports = __toCommonJS(toolsSlice_exports);
...
var createToolsSlice = (set, get) => ({
  ...
  // Clear all tools
  clearTools: () => {
    set({ registeredTools: /* @__PURE__ */ new Map() });
  }
});
