...
var stateSlice_exports = {};
__export(stateSlice_exports, {
  createStateSlice: () => createStateSlice,
  isRegisteredState: () => isRegisteredState
});
module.exports = __toCommonJS(stateSlice_exports);
...
var createStateSlice = (set, get) => {
  return {
    ...
    setCedarState: (key, value, isDiffChange = false) => {
      ...
      if ((0, import_lodash.isEqual)(existingState.value, value)) {
        return;
      }
      set(
        (state) => ({
...
function isRegisteredState(value) {
  return typeof value === "object" && value !== null && "value" in value && "key" in value && ("stateSetters" in value || "customSetters" in value) && "schema" in value;
}
