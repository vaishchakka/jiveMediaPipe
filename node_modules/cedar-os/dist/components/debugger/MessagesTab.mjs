...
var MessagesTab = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "h-full flex flex-col", children: [
    threads.size > 1 && /* @__PURE__ */ jsx("div", { className: "px-2 py-1 border-b border-gray-200 dark:border-gray-700", children: /* @__PURE__ */ jsxs(
      "select",
      {
        ...
        children: [
          ...
          Array.from(threads.entries()).map(([threadId, msgs]) => /* @__PURE__ */ jsxs("option", { value: threadId, children: [
            "Thread: ",
            threadId,
            " (",
            msgs.length,
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-y-auto p-2 space-y-1", children: currentMessages.length === 0 ? /* @__PURE__ */ jsx("div", { className: "text-center text-gray-500 dark:text-gray-400 py-4 text-xs", children: "No messages yet" }) : currentMessages.map((msg) => {
      ...
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between p-2 rounded-t-lg", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 flex-1", children: [
                msg.role === "user" ? /* @__PURE__ */ jsx(User, { className: "w-3 h-3" }) : /* @__PURE__ */ jsx(Bot, { className: "w-3 h-3" }),
                /* @__PURE__ */ jsx("span", { className: "font-medium text-xs", children: msg.role === "user" ? "User" : "Assistant" }),
                /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: cn(
                ...
                timestamp && /* @__PURE__ */ jsx("span", { className: "text-xs text-gray-500 dark:text-gray-500 ml-auto mr-2", children: timestamp })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                /* @__PURE__ */ jsx(
                  "button",
                  {
                    ...
                    children: copiedId === msg.id ? /* @__PURE__ */ jsx(Check, { className: "w-3 h-3 text-green-600" }) : /* @__PURE__ */ jsx(Copy, { className: "w-3 h-3" })
                  }
                ),
                isExpanded ? /* @__PURE__ */ jsx(ChevronDown, { className: "w-3 h-3" }) : /* @__PURE__ */ jsx(ChevronRight, { className: "w-3 h-3" })
              ] })
            ] }),
            !isExpanded && msg.content && /* @__PURE__ */ jsx("div", { className: "px-2 pb-2 text-xs text-gray-600 dark:text-gray-400 line-clamp-2", children: (() => {
            ...
            /* @__PURE__ */ jsx(AnimatePresence, { children: isExpanded && /* @__PURE__ */ jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsx("div", { className: "p-2 pt-0 rounded-b-lg", children: /* @__PURE__ */ jsx("pre", { className: "text-xs bg-gray-100 dark:bg-gray-800 p-2 rounded overflow-x-auto", children: JSON.stringify(msg, null, 2) }) })
              }
            ) })
          ]
        },
...
//# sourceMappingURL=MessagesTab.mjs.map